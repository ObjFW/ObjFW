...
const char *VER = "$VER: " OBJFWHID_AMIGA_LIB " "
...
struct OHLinklibContext linklibCtx;
...
libInit(struct ObjFWHIDBase *base, void *segList, struct ExecBase *sysBase)
{
...
libOpen(void)
{
	struct ObjFWHIDBase *base = (struct ObjFWHIDBase *)REG_A6, *child;
...
static void *
expunge(struct ObjFWHIDBase *base, struct ExecBase *sysBase)
{
...
libExpunge(void)
{
	struct ObjFWHIDBase *base = (struct ObjFWHIDBase *)REG_A6;
...
#define SysBase sysBase
	...
	if (base->parent != NULL) {
		struct ObjFWHIDBase *parent = base->parent;
...
bool
OHInit(unsigned int version, struct OHLinklibContext *ctx)
{
	register struct ObjFWHIDBase *r12 __asm__("r12");
	struct ObjFWHIDBase *base = r12;
	void *frame;
...
const struct Resident resident __attribute__((__section__(".rodata"))) = {
	...
	.rt_Type = NT_LIBRARY,
	.rt_Pri = 0,
	.rt_Name = (char *)OBJFWHID_AMIGA_LIB,
	.rt_IdString = (char *)OBJFWHID_AMIGA_LIB " "
	    OF_PREPROCESSOR_STRINGIFY(OBJFWHID_LIB_MINOR) "."
	    OF_PREPROCESSOR_STRINGIFY(OBJFWHID_LIB_PATCH)
	    " (" BUILD_DATE ") \xA9 2008-2026 Jonathan Schleifer",

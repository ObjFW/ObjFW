 ...
 *		    `nil` on success
 */
typedef void (^of_ip_stream_socket_async_connect_block_t)(
    OFIPStreamSocket *socket, id _Nullable exception);
 ...
 *	   connection
 */
typedef bool (^of_ip_stream_socket_async_accept_block_t)(
    OFIPStreamSocket *socket, OFIPStreamSocket *acceptedSocket,
    id _Nullable exception);
#endif

/*!
 * @protocol OFIPStreamSocketDelegate OFIPStreamSocket.h \
 *	     ObjFW/OFIPStreamSocket.h
 *
 * A delegate for OFIPStreamSocket.
 */
@protocol OFIPStreamSocketDelegate <OFStreamDelegate>
@optional
/*!
 ...
 *		    success
 */
-     (void)socket: (OFIPStreamSocket *)socket
 ...
 */
-    (bool)socket: (OFIPStreamSocket *)socket
  didAcceptSocket: (OFIPStreamSocket *)acceptedSocket
	exception: (nullable id)exception;
@end

/*!
 * @class OFIPStreamSocket OFIPStreamSocket.h ObjFW/OFIPStreamSocket.h
 *
 * @brief A class which provides methods to create and use IP stream sockets.
 *
 * To connect to a server, create a socket and connect it.
 * To create a server, create a socket, bind it and listen on it.
 */
@interface OFIPStreamSocket: OFStreamSocket
{
	bool _listening;
...
@property OF_NULLABLE_PROPERTY (assign, nonatomic)
    id <OFIPStreamSocketDelegate> delegate;

/*!
 * @brief Connect the OFIPStreamSocket to the specified destination.
 *
...
/*!
 * @brief Asynchronously connect the OFIPStreamSocket to the specified
 *	  destination.
 *
 * @param host The host to connect to
 * @param port The port on the host to connect to
 ...
 *
 * @return An autoreleased OFIPStreamSocket for the accepted connection.
 */
- (instancetype)accept;

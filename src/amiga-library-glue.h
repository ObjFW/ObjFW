...
extern const OFNetworkInterfaceKey *_Nonnull glue_OFNetworkInterfaceIPv6AddressesRef(void);
extern const OFNetworkInterfaceKey *_Nonnull glue_OFNetworkInterfaceIPXAddressesRef(void);
extern const OFNetworkInterfaceKey *_Nonnull glue_OFNetworkInterfaceAppleTalkAddressesRef(void);
